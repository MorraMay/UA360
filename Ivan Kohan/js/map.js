    ...
    var map = L.map('mapid').setView([48.8566, 31.3522], 6);
    ...
    var optionColorScheme = 3; // from 0 to 8. Check the https://rainviewer.com/api/color-schemes.html for additional information
